...
class TestAppendContextProvider(unittest.TestCase):
    ...
    def test_add_argument(self):
        ...
        mock_parser.add_argument.assert_called_once_with("--append", "-a", help=AppendContextProvider.get_help())

    def test_get_help(self):
        self.assertEqual(AppendContextProvider.get_help(), "Append to the specified file")
    ...
    def test_add_to_prompt(self):
        ...
        self.mock_prompt_builder.add_text.assert_called_once_with("Append to test.txt", "append_command")
