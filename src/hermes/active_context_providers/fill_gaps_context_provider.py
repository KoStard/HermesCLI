...
class FillGapsContextProvider(FileContextProvider):
    ...
    def get_action_instructions_reduced(self) -> str:
        return "<Reducted Request: You were asked to fill gaps in a file, and reply with a specific format. This applies only to the message you replied with, next messages are not affected.>"
