...
class Command(ABC):
    ...
    def __init__(self, name: str, help_text: str = "", command_type: CommandType = CommandType.BLOCK):
        self.name = name
        self.help_text = help_text
        self.command_type = command_type
        self.sections: List[CommandSection] = []
    
    def add_section(self, name: str, required: bool = True, help_text: str = "") -> None:
