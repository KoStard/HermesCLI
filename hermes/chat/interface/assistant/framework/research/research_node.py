...
from hermes.chat.interface.assistant.framework.research.file_system.dual_directory_file_system import DualDirectoryFileSystem
from hermes.chat.interface.assistant.framework.research.file_system.markdown_file_with_metadata import (
    MarkdownFileWithMetadataImpl,
)
from hermes.chat.interface.assistant.framework.research.research_node_component.artifact import (
    Artifact,
    ArtifactManager,
)
from hermes.chat.interface.assistant.framework.research.research_node_component.criteria_manager import (
    CriteriaManager,
    Criterion,
)
from hermes.chat.interface.assistant.framework.research.research_node_component.history.history import (
    ResearchNodeHistory,
)
from hermes.chat.interface.assistant.framework.research.research_node_component.logger import ResearchNodeLogger
...
from hermes.chat.interface.assistant.framework.research.research_node_component.state import (
    NodeState,
    StateManager,
)

if TYPE_CHECKING:
    from hermes.chat.interface.assistant.framework.task_tree import TaskTree
