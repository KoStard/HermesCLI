...
from hermes.chat.interface.assistant.framework.commands.command_context import CommandContext
...
if TYPE_CHECKING:
    ...
    from hermes.chat.interface.assistant.framework.task_processor import TaskProcessor
