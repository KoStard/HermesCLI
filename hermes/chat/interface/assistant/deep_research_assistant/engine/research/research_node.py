...
from hermes.chat.interface.assistant.deep_research_assistant.engine.research.research_node_component.artifact import Artifact, ArtifactManager
...
class ResearchNodeImpl(ResearchNode):
    def __init__(self, problem: ProblemDefinition, title: str, parent: 'ResearchNodeImpl' = None) -> None:
        ...
        self.parent: Optional['ResearchNodeImpl'] = parent
        ...
        self.logger: Optional[ResearchNodeLogger] = None
    ...
    def get_parent(self) -> Optional[ResearchNode]:
        return self.parent
